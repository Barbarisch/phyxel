...
- 2026-09-23 — **Glass is blended again: the OIT pass is re-enabled, and glass casts no shadow**
  ...
  (`GlassTransparency.md` §10). Changes: `voxel.frag` discards transparent faces (bit 1) so they are drawn by OIT only;
