                                              ...
                                              VkDescriptorSetLayout uboLayout)
{
    ...
    // loc 3: uvScale        (vec2, 8 bytes at offset 32)
    attrs[3] = {5, 0, VK_FORMAT_R32G32_SFLOAT,        offsetof(Core::KinematicFaceData, uvScale)};
    // loc 4: textureIndex   (uint, 4 bytes at offset 40)
    attrs[4] = {3, 0, VK_FORMAT_R32_UINT,             offsetof(Core::KinematicFaceData, textureIndex)};
    // loc 5: faceId         (uint, 4 bytes at offset 44)
    attrs[5] = {4, 0, VK_FORMAT_R32_UINT,             offsetof(Core::KinematicFaceData, faceId)};
