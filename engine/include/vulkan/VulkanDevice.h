...
struct UniformBufferObject {
    ...
    // ---- Wind debug view (debugShadowMode 10; 2026-09-03) ------------------------------------
    ...
    // RenderCoordinator right after WindSystem::tick. Appended AFTER the lighting arc's fields
    // (merge 2026-09-03), per the same trailing-field rule.
    ...
    alignas(16) glm::vec4 windDebugB{0.020f, 2.2f, 0.0f, 0.0f};
};
...
private:
    ...
    glm::vec4 m_windDebugB{0.020f, 2.2f, 0.0f, 0.0f};
